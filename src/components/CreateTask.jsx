...
export default function CreateTask({ open, onClose, addTask, editTaskdata,onTaskUpdate}) {
  ...
  return (
    <>
      <Dialog open={open} onClose={onClose} fullWidth maxWidth="md">
        <DialogTitle className="bg-gradient-to-r from-blue-600 to-indigo-700 px-2 py-1 text-white">{ editTaskdata ? "Edit Task 📊" :"Create Task 📊"}</DialogTitle>
        <DialogContent>
